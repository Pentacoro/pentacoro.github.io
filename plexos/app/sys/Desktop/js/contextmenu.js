    ...
    {name: "view", list: [
        {name:"Grid",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/grid2.svg')",func:[
            {name:"grid", list: [
                ...
                {name:"Grid Settings",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/gridsettings.svg')",func:() => runLauncher("/plexos/app/sys/Settings/Grid/deskGridOptions.ls",[],task)},
                ]
            }
        ]},
    ...
    {name: "file", list: [
        {name:"New",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/new2.svg')",func:[
            {name:"new", list: [
                ...
                {name:"Text Document",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/textfile.svg')",func:() => task.mem.new("StringFile", "New Text Document.txt")},
                ]
            }
        ]},
        ...
        case "web":
            return [
                ...
                {name: "prop", list: [
                    ...
                    {name:"Rename",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/rename.svg')",func: () => icon.editName(e),bool:File.at(icon.file)!=undefined},
                    {name:"Properties",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/properties.svg')",func: () => {runLauncher("/plexos/app/sys/File Properties/prop.ls",File.at(icon.file))} }
                ]},
            ]
        break
        default:
