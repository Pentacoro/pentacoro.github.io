...
*/
mem.codeParser.Match = function(index, classes, type, length, match, precedence) {
    this.index = index;
...
*/
mem.codeParser.RegexHighlighter = function(returnClassName) {
    this.returnClassName = returnClassName;
    if (typeof this.returnClassName === "undefined")
        this.returnClassName = "regex-highlight";
}

var Match = mem.codeParser.Match
var RegexHighlighter = mem.codeParser.RegexHighlighter
...
RegexHighlighter.prototype.findRegexMatches = function(string, regexString, captureGroup, type, precedence) {
    ...
    var match = string.match(reg, string)
