[
    ...
    {class: "IconDesk", menu: [
        {name: "open", list: [
            {name:"Open",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/open.svg')",func: () => console.log(File.at(ContextMenu.target.file))},//File.at(ContextMenu.target.file).open()},
        ]},
        {name: "null", list: null},
        {name: "clip", list: [
            {name:"Cut",icon:"url('plexos/res/themes/Plexos Hyper/icons/interface/contextMenu/cut.svg')",func: () => {return} },
